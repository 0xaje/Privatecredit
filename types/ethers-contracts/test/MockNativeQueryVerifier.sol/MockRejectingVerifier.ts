...
export declare namespace INativeQueryVerifier {
  ...
  export interface MockRejectingVerifierInterface extends Interface {
  ...
  export interface MockRejectingVerifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockRejectingVerifier;
    waitForDeployment(): Promise<this>;

    interface: MockRejectingVerifierInterface;
